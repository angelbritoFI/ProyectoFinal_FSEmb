...
# Version 1.2
# Date: 06/12/2021
# Description: Simulador de un invernadero, este simulador nos mostrará los componentes 
#   que se activan o desactivan, dependiendo de las acciones realizadas por el servidor web/invernadero,
#   el cual puede ser reemplazado por la implementación física siendo este simulador, solamente eso, un simulador visual de dicha implementación
...
#Permite actualizar el valor "medido" por el termómetro
...
def animacionVentilador(pot):
    ...
    while activa_Vent:
        ...
        #Dependiendo de donde se haya detenido el ventilador, mostrará la siguiente imagen
        if imgActual_Vent == 0:
            imgVent = ImageTk.PhotoImage(Image.open("Images/ventilador1.png"))
...
def calienta(potencia):
    ...
    #Se asignará una imagen dependiendo de la potencia
    if pot <= 25 and pot != 0:
